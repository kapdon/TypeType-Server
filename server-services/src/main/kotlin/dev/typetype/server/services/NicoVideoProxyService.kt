...
fun parseNicoCookie(fragment: String): String? {
...
fun rewriteNicoManifest(manifest: String, baseUrl: String, domandBid: String? = null, proxyPath: String = "nicovideo"): String {
